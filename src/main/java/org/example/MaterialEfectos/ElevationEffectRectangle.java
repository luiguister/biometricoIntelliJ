package org.example.MaterialEfectos;

import org.example.MaterialSwing.MaterialButton;
...
public class ElevationEffectRectangle {
     ...
     * @see MaterialButton for an example of how the ripple effect is used
     */
    public static ElevationEffectRectangle applyCircularTo(JComponent target, int level) {
